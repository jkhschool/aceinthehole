...
<body>
    ...
    <h3 class="date">June 22<small class=smalldate>nd</small> and 23<small class="smalldate">rd</small>, 2019 -<span class="evenbody">Events for Every Body!</span><span class="join">Join Us!</span></h3>
    ...
    <section class="container intro">
        <section class="row">
            ...
            <article class="col-md-9 mobiledisplay">
                <img src="img/5.jpg" alt="Man running">
            </article>
            <article class="col-md-3 testhome floathome acebout">
                <div class="aboutacediv">
                    <h2 class="aboutacehead">About Ace in the Hole</h2>
                    <p class="aboutace">Ace in the Hole Multisport Events is proud to offer running and triathlon events to athletes of all shapes and sizes, national origins, sexual orientations and cultural backgrounds. We offer <span class="everybody">Events for Every Body.</span></p>
                </div>
    ...
    <section class="container">
        <section class="row">
            <article class="col-md-12 aboutus">
    ...
    <section class="container">
        <section class="row">
            <article class="col col-md-6 social-media-col left-feed">
            ...
            <article class="col col-md-6 social-media-col right-feed">
                <div class="fb-page fbdime" data-href="https://www.facebook.com/cas222cascade/" data-tabs="timeline" data-width="694" data-height="" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
