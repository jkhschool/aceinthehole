<?php define('BASE_URL', '/soft_launch/'); ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <h2 class="rform">Contact Us!</h2>
        <section class="row">
            <article class="col-xs-12">
                <form role="form" method=post action=" " id="contactForm" novalidate="true">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            <button type="submit" value="submit" id="form-submit" class="btn btn-success btn-lg">Send</button>
                        </div>
                    </div>
                </form>
            </article>
